    ...
    return (
        <section className="w-full py-24 bg-gray-100 dark:bg-gray-800" id="contact">
            <div className="container px-4 md:px-6">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Email: mark.scharmann.ms@gmail.com</p>
                ...
                <a className="text-blue-600 hover:text-green-500 ml-4" href="https://www.hackerrank.com/profile/m98_hr">
                    HackerRank
                </a>
            </div>
